...
Выход нового JavaScript **ES2015** у всех на устах. Но уже сегодня пока мы ждем когда браузеры включат поддержку для **ES2015**, можно использовать эту спецификацию. Например в **NodeJs** или в браузерах с помощью **BabelJs**.
...
Для доступа ко всем переданным параметрам, в **JavaScript** каждая функция имеет доступ к специальной переменной -- ``arguments`` . 
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/z46j3q0o/).
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/z34kksh8/).
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/b8yxdddu/1/).
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/tp92csx2/1/).
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/a2ed27h8/).
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/tah8sx36/).
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/Lym1kn67/).
...
- Попробовать работу кода можно в [JsFiddle](https://jsfiddle.net/372d1gt5/).
